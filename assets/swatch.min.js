...
!(function ($) {
    ...
    function updateGroupVariant(t, e, a, i, o, n) {
        ...
        use_vimg &&
            ...
            void 0 !== n &&
            ((ck_pr_is_ungroup = !1),
            (a = $(t + ' [data-opname="' + (e = n) + '"] .is-selected').data("value")),
            GrnameValue != a &&
                ((GrnameValue = a),
                ...
                $(s + ' [data-grname="not4"]').length != $(s + " [data-grname]").length &&
                    ...
                    "#cart-form_ppr" == t && 0 < $(".p-thumb.isotope_ok").length
                        ? ($(".last_visible").removeClass("last_visible"),
                          ...
                          $('[data-featured-product-se][data-id="' + i + '"] .p-thumb[class*="t4s_media_size_"]').removeClass(function (t, e) {
                              return (e.match(/(^|\s)t4s_media_size_\S+/g) || []).join(" ");
                          }),
                          (c = $(".js-sl-item:not(.is_varhide)").length) < 3 ? (c = 1) : 3 == c || 5 == c || (c = 6),
                          $('[data-featured-product-se][data-id="' + i + '"] .p-thumb').addClass("t4s_media_size_" + c),
                        ...
                        : ((i = JSON.parse($(s + ".flickityt4s-enabled").attr("data-flickityt4s-js") || "{}")),
                          (c = JSON.parse($(r + ".flickityt4s-enabled").attr("data-flickityjs") || "{}")),
    ...
    geckoShopify.Ntproduct_switch = function (t, a, e, v, k, b, w, S) {
        ...
        var C,
            i,
            j = $('.p-thumb [data-grname]:not([data-grname="not4"])').attr("data-grname"),
            x = e.variants,
            T = $(t),
            I = e.ck_so_un,
            D = e.ntsoldout,
            ...
            T.on("click", ".swatches-select > .nt-swatch:not(.is-selected):not(.nt_unavailable)", function (t) {
                ...
                if (
                    ...
                    l.featured_media && (C = l.featured_media.id),
                        ...
                        s != n.val() && selectCallback(l, v, k, q, w, b, S, z, t, pr_incoming_mess, use_notify_me, save_js, enableHistoryState);
                }
            }),
            use_clicking_vimg &&
                ($(b + "0 .nt-swatch").each(function (t) {
                ...
                0 != (i = $(".p-thumb" + S + ".flickityt4s-enabled")).length &&
                    i.on("select.flickityt4s", function (t, e) {
                        $(w + " .variations .nt-swatch.is-selected").length < q ||
                            ((e = i.find(".flickityt4s-slider .js-sl-item").eq(e).data("mdid")),
                            C == e ||
                                a.indexOf(e) < 0 ||
                                ((C = e),
                                0 !=
    ...
    function selectCallback(t, e, a, i, o, n, s, r, c, l, d, p, _) {
            ...
            t &&
                ...
                t.available
                    ? (geckoShopify._updateStoreAvailabilityContent(J, !0, t.id),
                      ...
                      (f = a <= 0 && null != o) ? (x.css("display", "none"), U.hide(), H.show(), Y.hide(), N.show()) : (H.hide(), U.show(), N.hide(), Y.show()),
                    ...
                    : (geckoShopify._updateStoreAvailabilityContent(J, !1),
                      ...
                      d && (O.slideDown(350), (u = O.find("textarea").text()), O.find("textarea").text(u.replace("[variant]", t.title).replace("[url]", "?variant=" + t.id)))),
                (V = geckoShopify.formatMoney(t.price)),
                (O = (d = $("#product" + s.replace("_ppr", "").replace("_", "") + "-" + r)).find(".onsale")),
                (u = d.find(".txt_sale")),
                (r = d.find(".price_range").attr("data-txtsale")),
                t.compare_at_price > t.price
                    ? ((d = "<del>" + geckoShopify.formatMoney(t.compare_at_price) + "</del> <ins>" + V + "</ins>"),
                      (d += ' <span class="onsale fs__14 tu dib cw pr_onsale hide"><span></span></span>'),
                      ...
                      O.show(),
                      "1" == r ? u.html(save2_js.replace("[sale]", Math.round(d))) : "2" == r && ((d = t.compare_at_price - t.price), (d = geckoShopify.formatMoney(d)), u.html(save3_js.replace("[sale]", d))))
                    : (M.html(V), O.hide()),
                t.unit_price && (q.html(geckoShopify.formatMoney(t.unit_price)), z.html(getBaseUnit(t))),
                body.trigger("refresh_currency"),
                t.sku ? (b.css("display", "none"), k.text(t.sku).css("display", "inline-block")) : (k.css("display", "none"), b.css("display", "inline-block")),
                t.barcode ? (S.css("display", "none"), w.text(t.barcode).css("display", "inline-block")) : (w.css("display", "none"), S.css("display", "inline-block")),
                t.featured_media &&
                    !ntla_ck &&
                    ((w = t.featured_media.id),
                    1 == (S = $('.p-thumb [data-mdid="' + w + '"]').first()).length && "#cart-form_ppr" == e && 0 < $(".p-thumb.isotope_ok").length
      ...
      // custom code started
      var dis_custom = document.getElementById("dis_custom").value;
      var final_price = t.price / 100;
      let custom_price_d = Math.round(final_price * dis_custom / 100);
      let custom_price = Math.round(final_price - custom_price_d);
      let formattedAmount = new Intl.NumberFormat('en-IN', { minimumFractionDigits: 2 }).format(custom_price);
      var final_text = "Rs. "+ formattedAmount ;
      document.getElementById("custom-price").innerHTML = final_text;
       // custom code end
    }
    ...
    function updateImageVariantPositionSlider(t, e, a, i) {
        ...
        "#cart-form_ppr" == t ? (i = ".p-thumb") : "#cart-form_qv" == t ? (i = ".nt_carousel_qv") : "#cart-form_qs" == t && (i = ".nt_carousel_qs"),
            i.length < 1 || 0 == $(i + '.flickityt4s-enabled [data-mdid="' + e + '"]').length || $(i + ".flickityt4s-enabled").flickityt4s("selectCell", '[data-mdid="' + e + '"]', !1, a);
    }
    ...
    function addItem(t, e) {
        fetch(cartAddUrl, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ items: t, sections: Sections_nt }) })
            .then(function (t) {
                return t.json();
            })
            .then(function (t) {
    ...
    function addItemFrom(e, t) {
        ...
        function o(t) {
            fetch(cartAddUrl, { method: "POST", credentials: "same-origin", headers: { "Content-Type": "application/x-www-form-urlencoded", "X-Requested-With": "XMLHttpRequest" }, body: serializet4(t[0]) + "&sections=" + Sections_nt })
                .then(function (t) {
                    return t.json();
                })
                .then(function (t) {
    ...
    function changeItem(t, a, i) {
        t = { method: "POST", headers: { "Content-Type": "application/json;" }, body: JSON.stringify({ id: t, quantity: a, sections: Sections_nt }) };
        function o() {
    ...
    (geckoShopify.CanvasConfetti = function (t) {
        ...
        (geckoShopify.GetCartData = function (e, a, i) {
            fetch(location.href.split("?")[0] + "/?section_id=cart_js", { credentials: "same-origin", headers: { "cache-control": "no-cache" } })
                .then(function (t) {
                    return t.text();
                })
                .then(function (t) {
        ...
        (geckoShopify.onCartUpdate = function (t, e, a, i) {
            if (body.hasClass("template-cart")) {
                ...
                (s = o[0]) != n &&
                    (body.removeClass("t4_cart_count_" + n).addClass("t4_cart_count_" + s),
                    0 == parseInt(s)
                    ...
                    (r = o[1].split(",]")),
                    (c = $(".cart_thres_" + r[0])),
                    "spt4" != r && (c.is(":hidden") && ($(".cart_thres_1,.cart_thres_2,.cart_thres_3").slideUp(200), c.slideDown(250)), (ck_canvas = !(0 == s || !$(".cart_thres_3").is(":hidden"))), UpdateShipBar(o[1], r[1], c)),
                    ...
                    e && $("html, body").animate({ scrollTop: $(".cart_page_section").offset().top - 40 }, 400);
            } else {
                var s,
                    r,
                    c,
                ...
                (s = o[0]) != n &&
                    ...
                    $(".js_cat_dics").html(o[3]),
                    $(".js_cat_ttprice").html(o[4]),
                    "1" == o[5] ? ($(".js_cart_tls_back").trigger("click"), $(".js_gift_wrap").addClass("dn")) : $(".js_gift_wrap").removeClass("dn"),
                    null != o[6] && "" != o[6] && $(".js_cat_cus1").html(o[6]),
                    null != o[7] && "" != o[7] && $(".js_cat_cus2").html(o[7]),
    ...
    (geckoShopify.AgreeCheckout = function () {
        ...
        (geckoShopify.productImages = function () {
            ...
            body.hasClass("template-product") &&
                ...
                (_.hasClass("img_action_popup") || ($(window).width() <= 1024 && nt_settings.zoom_mb)) && (e += ", .p-thumb .img_ptw"),
                ...
                t.on("click", e, function (t) {
                    ...
                    t.preventDefault(),
                        ...
                        "mfp" == s && o
                            ? $.magnificPopup.open({ type: "image", tClose: nt_settings.close, image: { verticalFit: !1 }, items: d(), gallery: { enabled: !0, navigateByImgClick: !1 } }, 0)
                            : "pswp" == s && o
                            ? (((0 < $(".thumb_2").length || 0 < $(".thumb_3").length || 0 < $(".thumb_7").length) && (r = n.find(".js-sl-item:not(.is_varhide) .img_ptw")).length) || (r = n.find(".img_ptw:not(.is_varhide)")),
                              ...
                              (a = d("thumb")),
                              (i = $(".pswp__thumbnails")),
                              (t = $(".p-thumb").hasClass("isotope_ok") ? $(this).parents().index() : l(t)),
                              c((t = -1 == t ? 0 : t), e),
                              0 < i.length && 1 < r.length && (i.html(a), $(".pswp_thumb_item:eq(" + t + ")").addClass("pswp_tb_active"), p()))
                            : (o = !0);
                }),
                (c = function (t, e) {
                    var a = document.querySelectorAll(".pswp_t4_js")[0],
                        ...
                        "" !== t.trim()
                            ? (n.html(t),
                              ...
                              "3" == o &&
                                  ...
                                  window.ShopifyAnalytics.lib.track("Product Recommendations Displayed", { theme: "Kalles", didPageJumpOccur: t, numberOfRecommendationsDisplayed: i })),
                              geckoShopify.review(),
                              geckoShopify.lazyWishUpdate())
                            : n.slideUp();
                    },
                        ...
                        e.hasClass("active")
                            ...
                            : (a.find(".sp-tab").removeClass("active"),
                              ...
                              setTimeout(function () {
                                  ...
                                  geckoShopify.isVisible(t, !0) || ((t = $(".ntheader.live_stuck .sp_header_mid").height() || 0), (t = i.find(".sp-tab.active").offset().top - t - 10), $("body,html").animate({ scrollTop: t }));
                              }, 200));
                });
        }),
                    ...
                    n.removeClass("t4_show"),
                        $(window).width() <= 1024 ||
                            ...
                            i <= a ||
                                ...
                                (o = s.find('.flickityt4s-slider .n-item[data-mdid="' + i + '"]').position().top + s.position().top - (a + o) / 2),
    ...
    var jsonIcons = { video: "las la-play", external_videoyoutube: "lab la-youtube", external_videovimeo: "lab la-vimeo", model: "las la-cube" };
    (geckoShopify.productImagesThumb = function (i, o) {
        ...
        0 != n.length &&
            ...
            (d = 0 < $(".thumb_left").length || 0 < $(".thumb_right").length ? "col-lg-12 " : ""),
            t.each(function (t) {
                var e,
                    c,
                    l,
